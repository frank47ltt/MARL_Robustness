...
class ADV_QMIX:
    def __init__(self, args):
        ...
        self.model_dir = self.args.model_dir + '/' + self.args.alg + '/' + self.args.map_name
        ...
        if self.args.load_model:
            if os.path.exists(self.model_dir + '/rnn_net_params.pkl'):
                ...
                print('Model Loading Successful: {} and {}'.format(path_rnn, path_qmix))
            else:
