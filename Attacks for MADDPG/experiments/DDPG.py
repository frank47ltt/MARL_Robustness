...
class DDPG(object):
    ...
    def _build_a(self, s, reuse=None, custom_getter=None):
        ...
        with tf.variable_scope('Actor', reuse=reuse, custom_getter=custom_getter):
            ...
            a = tf.layers.dense(net, self.a_dim, activation=tf.nn.tanh, name='a', trainable=trainable) # originally tanh
    ...
    def save(self):
        model = a_
        model.save_weights("./weights_DDPG_Adv_PD_final/")
...
def train():
    ...
    print("s_dim is " + str(s_dim))
    a_dim = env.action_space.shape[0]
    print("a_dim is " + str(a_dim))
